...
| **3** | **P6 · offline** | 🟡 **construido 2026-08-06/07** | Cierra el principio no negociable #4. `expo-sqlite` + cola propia (**no WatermelonDB** — ver `plans/P6-offline-sync.md §4`). **Smoke real en el dispositivo verde**: leer, escribir, sobrevivir al cierre y drenar solo. Falta `/code-review` + `/ponytail-review` y el merge |
