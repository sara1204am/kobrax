...
| W4 | Import | `/imports/portfolio`: configuración de columnas, preview y conciliación. **Es el gap que el móvil dejó anotado**: el import de oficina se hace en pantalla grande | W3 | ✅ mergeada (12/08) |
