 ...
 *
 * Puro y sin red: es la misma idea que `route-draft.diffStops`, y por las mismas razones — se testea
 * solo, y guardar sin tocar nada no dispara ni una llamada.
 */
import type { ClienteForm, ContactRow, LocationRow, RelationRow } from './cliente-form';
...
export function hasChanges(ops: ClienteOps): boolean {
